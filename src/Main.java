...
public class Main extends Application {
	...
	public void start(Stage stage) {
		...
		vbxRow1.setStyle("-fx-background-color: #0b3142;");
		HBox hbxLogo = new HBox(5);
		hbxLogo.setStyle("-fx-background-color: #0f5257;");
		...
		vbxRow2.setStyle("-fx-background-color: #9c92a3;");
		...
		// Add the image to the button and set the background of the button to
		// transparent
		...
		lblAppTitle.setStyle("-fx-text-fill: #0b3142;" + "-fx-font-size: 30px;" + "-fx-font-weight: bolder;");
		...
		lblTitle.setStyle("-fx-text-fill: #0b3142;" + "-fx-font-size: 23px;" + "-fx-font-weight: bolder;");
	...
	private void setVbxRow2Contents(String UIName) {
		...
		// lblTitle.setText("Cars Summary");
		// uiContent = carSummaryUI.getContent();
		// hbxContent.getChildren().set(0, uiContent);
		// hbxContent.setHgrow(uiContent, Priority.ALWAYS);
		// break;
		default:
